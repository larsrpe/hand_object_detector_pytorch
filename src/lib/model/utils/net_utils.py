...
from src.lib.model.utils.viz_hand_obj import *
...
def vis_detections_filtered_objects_PIL(im, obj_dets, hand_dets, thresh_hand=0.8, thresh_obj=0.01, font_path='src/lib/model/utils/times_b.ttf'):
